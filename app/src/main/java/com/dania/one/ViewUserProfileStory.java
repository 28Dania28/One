...
//Add animation to promote / demote textview
//notifiedDataSetChange on adding new items to stack
public class ViewUserProfileStory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_user_profile_story);
        Intent i = getIntent();
        if (i!=null){
        ...
        size = StoriesFetchedGlobal.allUserStoryModels.size();
        ...
        csv.setAdapter(new ViewUserStoriesAdapter(getApplicationContext(),StoriesFetchedGlobal.allUserStoryModels));
