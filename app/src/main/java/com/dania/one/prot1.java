    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tagBuddiesBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ActivityOptionsCompat options = ActivityOptionsCompat.makeSceneTransitionAnimation(prot1.this, p1);
            ...
            uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task task) {
                    if (task.isSuccessful()) {
                        ...
                        DatabaseReference user_ref = FirebaseDatabase.getInstance().getReference("Users").child(my_id);
                        ...
                        user_ref.child("last_story").setValue(timestamp).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                Toast.makeText(prot1.this, "Story added!!", Toast.LENGTH_SHORT).show();
