...
public class search_user_adapter extends RecyclerView.Adapter <search_user_adapter.chatFriendViewHolder>{

    Context context;
    ArrayList<FriendModel> friendModels;


    public search_user_adapter(Context context, ArrayList<FriendModel> friendModels) {
    ...
    @NonNull
    @Override
    public search_user_adapter.chatFriendViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull search_user_adapter.chatFriendViewHolder holder, int position) {
