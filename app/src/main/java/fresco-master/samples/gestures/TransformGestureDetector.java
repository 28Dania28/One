...
public class TransformGestureDetector implements com.facebook.samples.gestures.MultiPointerGestureDetector.Listener {
  ...
  private final com.facebook.samples.gestures.MultiPointerGestureDetector mDetector;

  @Nullable private Listener mListener = null;

  public TransformGestureDetector(com.facebook.samples.gestures.MultiPointerGestureDetector multiPointerGestureDetector) {
  ...
  public static TransformGestureDetector newInstance() {
    return new TransformGestureDetector(com.facebook.samples.gestures.MultiPointerGestureDetector.newInstance());
  }
  ...
  @Override
  public void onGestureBegin(com.facebook.samples.gestures.MultiPointerGestureDetector detector) {
    if (mListener != null) {
  ...
  @Override
  public void onGestureUpdate(com.facebook.samples.gestures.MultiPointerGestureDetector detector) {
    if (mListener != null) {
  ...
  @Override
  public void onGestureEnd(com.facebook.samples.gestures.MultiPointerGestureDetector detector) {
    if (mListener != null) {
