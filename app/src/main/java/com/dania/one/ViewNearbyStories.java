...
public class ViewNearbyStories extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_nearby_stories);
        Intent i = getIntent();
        if (i!=null){
        ...
        size = StoriesFetchedGlobal.nearbyStoryModels.size();
...
//                    getMoreNearbyStories();
        ...
        csv.setAdapter(new ViewUserStoriesAdapter(getApplicationContext(),StoriesFetchedGlobal.nearbyStoryModels));
    ...
    public int getCursorPosition(int position){
        ...
        for (int i=0;i<position;i++){
            number = number+StoriesFetchedGlobal.nearbyStoryPackets.get(i).getStoryModels().size();
        }
        return number;
    }
